export const translations = {
  de: {
    ...
    join: {
      ...
      selectMember: "Wähle deinen Namen:",
      admin: "Admin",
      joinAsNew: "Als neues Mitglied beitreten",
      backToMembers: "Zurück zur Mitgliederauswahl",
    },
    userSettings: {
      title: "Dein Profil",
      yourName: "Dein Name",
      ...
      paypalLinkDesc:
        "Füge deinen PayPal.Me Link hinzu, damit andere Mitglieder ihre Schulden direkt bezahlen können.",
  ...
  en: {
    ...
    join: {
      ...
      admin: "Admin",
      joinAsNew: "Join as a new member",
      backToMembers: "Back to member selection",
    },
    userSettings: {
      title: "Your Profile",
      yourName: "Your Name",
      paypalLink: "PayPal.Me Link",
      paypalLinkDesc:
        "Add your PayPal.Me link so other members can pay their debts directly.",
